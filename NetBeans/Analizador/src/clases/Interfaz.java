...
public class Interfaz extends javax.swing.JFrame {
    ...
    public Interfaz() {
        ...
        txt_expresion.setText("{3+ [2-4] * (6+7) * {-5}}");
    }
    ...
    private void initComponents() {
        ...
        txt_expresion.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (ValidarExpresion()) {
            ...
            JOptionPane.showMessageDialog(null, "ERROR!!, La Formula NO Está Escrita Correctamente");
